  ...
  render: function() {
    ...
    return (<div className="container orient-vertical-box">
          <div className="w-menu">
            ...
            <a className="w-help-menu" href="https://github.com/whistle-plugins/whistle.scriptFake" target="_blank"><span className="glyphicon glyphicon-question-sign"></span>Help</a>
